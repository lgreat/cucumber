...
public class SchoolSearchWidgetControllerTest extends BaseControllerTestCase {
    ...
    public void testLoadResultsForCityNull() {
        ...
        expect(_schoolDao.findSchoolsWithRatingsInCity(State.CA, city.getName(),true)).andReturn(null);
        replayAll();
    ...
    public void testLoadResultsForCityEmpty() {
        City city = new City();
        city.setName("Alameda");
        expect(_schoolDao.findSchoolsWithRatingsInCity(State.CA, city.getName(),true)).andReturn(new ArrayList<SchoolWithRatings>());
        replayAll();
        assertFalse("Expect no results", _controller.loadResultsForCity(city, State.CA, _command));
        verifyAll();
        assertEquals(0, _command.getSchools().size());
    ...
    public void testLoadResultsForCity() {
        ...
        schools.add(struct1);
        expect(_schoolDao.findSchoolsWithRatingsInCity(State.CA, city.getName(),true)).andReturn(schools);
