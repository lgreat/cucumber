...
public class LinkTagHandlerTest extends BaseTestCase {
    ...
    public void testAbsoluteLink() throws JspException {
        ...
        final MockHttpServletRequest request = new GsMockHttpServletRequest();
    ...
    public void testSchools() {
        ...
        UrlBuilder builder = tagHandler.createUrlBuilder();
        assertEquals("/california/alameda/schools/?gradeLevels=e&p=2&showall=1&st=private", builder.asSiteRelative(null));
    ...
    public void testCompareSchoolsTagHandler() {
        ...
        builder = handler.createUrlBuilder();
        assertEquals("/school-comparison-tool/map.page?schools=ca1%2Cca2", builder.asSiteRelative(null));

        handler.setTab(CompareStudentTeacherController.TAB_NAME);
        builder = handler.createUrlBuilder();
        assertEquals("/school-comparison-tool/studentTeacher.page?schools=ca1%2Cca2", builder.asSiteRelative(null));

        handler.setTab(CompareProgramsExtracurricularsController.TAB_NAME);
        builder = handler.createUrlBuilder();
        assertEquals("/school-comparison-tool/programsExtracurriculars.page?schools=ca1%2Cca2", builder.asSiteRelative(null));
        ...
        handler.setSchools("ca1,ca2,ca3");
        handler.setRemove("ca1");
        builder = handler.createUrlBuilder();
        assertEquals("/school-comparison-tool/results.page?p=2&schools=ca2%2Cca3", builder.asSiteRelative(null));

        handler.setSchools("ca1,ca2,ca3");
        handler.setRemove("ca3");
        builder = handler.createUrlBuilder();
