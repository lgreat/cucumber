 ...
 * $Id: StateControllerTest.java,v 1.5 2005/12/01 20:32:53 apeterson Exp $
 */
...
public class StateControllerTest extends BaseControllerTestCase {
    ...
    public void testTopDistrictsController() throws Exception {
        ...
        Object header = modelAndView.getModel().get(UnorderedListModel.HEAD);
        assertNotNull(header);
        assertTrue(header instanceof String);
        assertEquals("California Districts", header);
        List results = (List) modelAndView.getModel().get(UnorderedListModel.RESULTS);
        ...
        assertNotNull(modelAndView.getModel().get(UnorderedListModel.RESULTS));
        ...
        header = modelAndView.getModel().get(UnorderedListModel.HEAD);
        assertNotNull(header);
        assertTrue(header instanceof String);
        assertEquals("Alaska Districts", header);
        results = (List) modelAndView.getModel().get(UnorderedListModel.RESULTS);
        assertNotNull(results);
    ...
    public void testTopCitiesController() throws Exception {
        ...
        final Object header = modelAndView.getModel().get(UnorderedListModel.HEAD);
        assertNotNull(header);
        assertTrue(header instanceof String);
