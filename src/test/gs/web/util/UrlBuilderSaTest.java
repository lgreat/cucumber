 ...
 * $Id: UrlBuilderSaTest.java,v 1.152 2012/10/11 14:40:30 yfan Exp $
 */
...
// Bulk adding
    ...
    public void testVPages() throws UnsupportedEncodingException {
        ...
        builder = new UrlBuilder(UrlBuilder.NEWSLETTER_UNSUBSCRIBE);
        assertEquals("/email/unsubscribe.page", builder.asSiteRelative(request));
    ...
    public void testDirectoryStructureUrlBuilder() {
        ...
        assertEquals("Unexpected URL", "/alaska/anchorage/schools/?gradeLevels=e&st=public&st=charter", builder.asSiteRelative(request));
    }
