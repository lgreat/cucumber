...
//    }
    ...
    private static void pipe(final RenderedImage img, String formatName, OutputStream out) throws IOException {
     ...
     * @throws IOException
     */
    public void setParameter(String name, String filename, String mimetype, String formatName, RenderedImage image) throws IOException {
        boundary();
        writeName(name);
        write("; filename=\"");
        write(filename);
