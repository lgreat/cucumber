...
import gs.web.about.feedback.AddFeedbackCommand;
 ...
 */
public class AddFeedbackCommandValidator implements IRequestAwareValidator  {
    public static final String BEAN_ID = "addFeedbackCommandValidator";
    ...
    public void validate(HttpServletRequest request, Object object, Errors errors) {
        AddFeedbackCommand command = (AddFeedbackCommand)object;
