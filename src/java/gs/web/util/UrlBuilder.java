...
public class UrlBuilder {
    ...
    public static final VPage NL_SIGN_UP_PAGE = new VPage("vpage:newslettersSignUp");
    ...
    private void initializeForCmsContent(ContentKey contentKey, String fullUri, Boolean raiseYourHand, String page, String language) {
        ...
        if (fullUri != null) {
            ...
            // GS-11495
            if (!CmsUtil.isCmsFeature(contentKey) && !CmsUtil.isCmsPage(contentKey) && !CmsUtil.hasSpecialCaseUrl(contentKey)) {
    ...
    public UrlBuilder(VPage page, State state, String cityName, Set<SchoolType> schoolTypes, LevelCode levelCode, Integer start) {
        ...
        if (SCHOOLS_IN_CITY.equals(page)) {
            ...
            if (schoolTypes != null && schoolTypes.size() < SchoolType.NUM_SCHOOL_TYPES) {
