 ...
 */
public class MssRegistrationHoverCommand extends UserRegistrationCommand implements EmailValidator.IEmail{
    ...
    public MssRegistrationHoverCommand() {
        super();
    }
    ...
    public boolean isMssJoin() {
        return MssRegistrationHoverCommand.JoinHoverType.Auto == getJoinHoverType();
    }
