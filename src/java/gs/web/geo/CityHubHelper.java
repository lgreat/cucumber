...
public class CityHubHelper {
    ...
    public static final String HUB_HOME_SHOULD_SHOW_ANNOUCMENT= "showannouncement";
    ...
    public static final String EDUCATIONCOMMUNITY_PAGE_SHOWTABS_MODEL_KEY = "showTabs";
