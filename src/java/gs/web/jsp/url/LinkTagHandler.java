 ...
 * $Id: LinkTagHandler.java,v 1.1 2009/01/03 01:08:24 thuss Exp $
 */
...
public abstract class LinkTagHandler extends TagSupport {
     ...
     * @return GSUrl subclass
     */
    protected abstract GSUrl createGSUrl();
    ...
    public int doStartTag() throws JspException {
        try {
            GSUrl gsUrl = createGSUrl();
            printATagStart(gsUrl);
        } catch (IOException e) {
    ...
    protected void printATagStart(GSUrl gsUrl) throws IOException {
        pageContext.getOut().print("<a");
        ...
        String href;
        if (isAbsolute()) {
            throw new UnsupportedOperationException("Absolute URL's are not yet supported");
        } else {
            href = gsUrl.getRelativePath();
        }
     ...
     * @param anchor The name of the anchor on the destination page
     */
