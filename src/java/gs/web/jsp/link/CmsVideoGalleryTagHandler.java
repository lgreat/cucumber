...
public class CmsVideoGalleryTagHandler extends LinkTagHandler {
    ...
    protected UrlBuilder createUrlBuilder() {
        return new UrlBuilder(UrlBuilder.CMS_VIDEO_GALLERY, _topicCenterId, _topicCenterUrl, _topicIDs, _gradeIDs, _subjectIDs, _language);
    }
