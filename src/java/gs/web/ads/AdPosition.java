 ...
 * $Id: AdPosition.java,v 1.62 2010/06/15 20:38:10 mwong Exp $
 */
package gs.web.ads;
...
public class AdPosition extends Enum {
    ...
    public static final AdPosition Library_Article_Page_Inline_598x50 = new AdPosition("Library_Article_Page_598x50", true); // GS-10041
