...
/**
 * This controller used to feed users to one of the other survey pages. Now it redirects to the school profile overview page.
 */
public class SchoolLevelController extends AbstractController {
