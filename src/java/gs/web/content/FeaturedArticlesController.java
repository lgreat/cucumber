 ...
 * $Id: FeaturedArticlesController.java,v 1.28 2009/06/18 23:08:19 eingenito Exp $
 */
    ...
    */
    ...
    private ModelAndView handleMultipleArticles(HttpServletRequest request, String posStr, int count) {
        ...
        if (StringUtils.equals(IArticleDao.FOCUS_ON_CHOICE, posStr)) {
            Anchor anchor = new Anchor(_urlUtil.buildUrl("/school-choice/?state=$STATE", request),
