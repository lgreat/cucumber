...
function setQuality(title, q) {
    ...
    document.getElementById('q_1').style.background="url(/res/img/school/review/stars.gif) no-repeat 0px 0px;";
    document.getElementById('q_2').style.background="url(/res/img/school/review/stars.gif) no-repeat 0px 0px;";
    document.getElementById('q_3').style.background="url(/res/img/school/review/stars.gif) no-repeat 0px 0px;";
    document.getElementById('q_4').style.background="url(/res/img/school/review/stars.gif) no-repeat 0px 0px;";
    document.getElementById('q_5').style.background="url(/res/img/school/review/stars.gif) no-repeat 0px 0px;";
