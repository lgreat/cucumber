...
function s_doPlugins(s) {
    ...
    s.prop23=s.eVar23=s.getClientTime('t','30'); // Set hour
    s.prop24=s.eVar24=s.getClientTime('d'); // Set day
...
s.trackingServer="gms.greatschools.org"
s.trackingServerSecure="sgms.greatschools.org"
