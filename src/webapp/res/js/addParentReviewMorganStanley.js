...
function validateReview() {
    ...
    if (!starSelected || ((jQuery('#reviewText').val() == '') || (jQuery('#reviewText').val() == 'Enter your review here'))) {
     ...
     if (jQuery('#reviewEmail').val() == '' || (jQuery('#reviewEmail').val() == 'Enter your email address') || (validateEmail(jQuery('#reviewEmail').val()) == false)) {
     jQuery('#emailError').show();
     jQuery('#parentRating').css('height',height + 28 + 'px');
     jQuery('#categoryRatings').css('height', height + 28 + 'px');
     height = height + 29;
     noError = false;
     } else {
     ...
     if (!jQuery('#permission').attr("checked")) {
