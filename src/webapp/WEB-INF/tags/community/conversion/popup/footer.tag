...
<table id="footer" width="100%" border="0">
    <tr>
        <td width="100%" align="center">
            <a href="https://${requestScope.context.secureHostName}/subscribe.page?state=${requestScope.context.stateOrDefault.abbreviation}&host=${requestScope.context.hostName}" target="_blank"><img src="/res/img/subscribe/conversion/popup/join_price_btn.gif" width="189" height="20" hspace="5" vspace="0" border="0"></a>
            <a href="http://${requestScope.context.hostName}/cgi-bin/site/findschool2review.cgi/${requestScope.context.stateOrDefault.abbreviation}/" target="_blank"><img src="/res/img/subscribe/conversion/try_sm_btn.gif" width="114" height="20" hspace="5" vspace="0" border="0"></a>
        </td>
        <td>
